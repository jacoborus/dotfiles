...
```sh
sudo apt install git curl ssh meld xclip xsel saidar tree silversearcher-ag zsh tmux highlight python-dev python-pip python3-dev python3-pip neovim p7zip-full
```
